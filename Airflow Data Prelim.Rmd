...
Data is rarely in a perfect form when first imported. 

WARNING: HARDCODED BUG: The year is automatically overridden to be 2022. Will need to change when the script is changed. 


```{r}
#Convert from Floatdate and floatTime to date-time object
(dataDate <- dataframe %>% mutate(month=floor(floatDate), 
                           ...
                           select(dateTime, r0_1, Cn2, residual_Kolmo, r0Kalman, L0Kalman, residual_Kalman, r0power, r0expo, residual_power, r0max, r0min, Cn2max, Cn2min, r0noTT.0., Cn2noTT, r0noTT.1., residual_KolmonoTT, imamax, npixsat, offsets.0., offsets.1., flagdata) )
```
